...
export default function FeaturedProducts() {
  ...
  const whatsappNumber = '254700000000' // Replace with your company WhatsApp phone number (with country code)
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Explore our most popular corporate apparel and uniforms. Click to order or make an inquiry via WhatsApp.
          </p>
        </motion.div>
          ...
          {featuredProducts.map((product) => {
            ...
            return (
              ...
              >
                ...
                {/* Direct Buy/Enquire WhatsApp Action Button */}
